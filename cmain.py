...
token_service = str()
tele_token = "6307675210:AAHmUq1gTcYKYN-eYq3SbBtREppsvYhUHq8"
...
async def processService(update,context):
...
async def chatMan(update,context):
    ...
    if iactive_cmd == None or iactive_cmd=="process_token":
        ...
        await processService(update,context)
...
def main():
    ...
    webhook_url = "https://artekreartwh-1-k6224123.deta.app"
    abot = tapp.bot#
    print(abot)
